...
### 石板青 3:4 渲染效果
![石板青 3:4 渲染效果](./previews/v2.4.0/slate_teal_3_4.jpg)

### 磨砂玻璃 1:1 渲染效果
![磨砂玻璃 1:1 渲染效果](./previews/v2.4.0/frosted_glass_1_1.jpg)

- **品牌专属勋章设计**：针对旗舰镜头引入了专属视觉风格。可自动识别佳能 L (红)、尼康 N (金)、以及索尼 GM、适马 A/S/C 等勋章，并在“高级设置”中支持全局开关。

![镜头标识展示](./previews/v2.4.0/lens_branding.jpg)
...
![构图设置界面](./previews/v2.4.0/border_settings.png)

## ⚡ 参数保存与持久化 (新增)

- **审美预设系统 (Border Presets)**：支持将当前所有的边框宽度、比例、字号、主题等审美参数一键保存为自定义预设。您可以为不同题材（如街拍、人像）建立专属的参数库，随时快速切换。
- **机型信息收藏 (EXIF Favorites)**：对于经常使用的非标设备或老镜头，您可以将自定义的品牌 (Make)、型号 (Model) 和镜头 (Lens) 信息保存到收藏夹中。下次处理同类照片时，只需下拉选择即可秒速填充，无需反复手动输入。
...
![多种比例与主题预览](./previews/v2.4.0/multi_aspect_ratio.png)
